...
class NormalBayesClassifier extends React.Component {
    constructor(props) {
        super(props)
        console.log(this.props);
        this.state = { title: "Normal Bayes Classifier", train: 70,
    ...
    handleTrain = (event, value) => {
        ...
        cvworker.postMessage({NormalBayesClassifier:cloned})
    };
...
export default NormalBayesClassifier;