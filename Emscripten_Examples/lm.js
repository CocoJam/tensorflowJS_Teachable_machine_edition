...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'lm.wast';
  var wasmBinaryFile = 'lm.wasm';
  var asmjsCodeFile = 'lm.temp.asm.js';
...
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__I_000101() } }, { func: function() { __GLOBAL__sub_I_lm_cpp() } }, { func: function() { __GLOBAL__sub_I_iostream_cpp() } });
...
var real___GLOBAL__sub_I_lm_cpp = asm["__GLOBAL__sub_I_lm_cpp"]; asm["__GLOBAL__sub_I_lm_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___GLOBAL__sub_I_lm_cpp.apply(null, arguments);
};
...
var __GLOBAL__sub_I_lm_cpp = Module["__GLOBAL__sub_I_lm_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_lm_cpp"].apply(null, arguments) };
