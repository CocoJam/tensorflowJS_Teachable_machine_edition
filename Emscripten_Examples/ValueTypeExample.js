...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'ValueTypeExample.wast';
  var wasmBinaryFile = 'ValueTypeExample.wasm';
  var asmjsCodeFile = 'ValueTypeExample.temp.asm.js';
...
STATICTOP = STATIC_BASE + 8368;
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__sub_I_ValueTypeExample_cpp() } }, { func: function() { __GLOBAL__sub_I_bind_cpp() } });
...
// {{PRE_LIBRARY}}
  ...
  function __Z20findPersonAtLocation7Point2f() {
  err('missing function: _Z20findPersonAtLocation7Point2f'); abort(-1);
  }
...
Module['wasmTableSize'] = 514;

Module['wasmMaxTableSize'] = 514;
...
Module["asm"] = asm;
var __GLOBAL__sub_I_ValueTypeExample_cpp = Module["__GLOBAL__sub_I_ValueTypeExample_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_ValueTypeExample_cpp"].apply(null, arguments) };
