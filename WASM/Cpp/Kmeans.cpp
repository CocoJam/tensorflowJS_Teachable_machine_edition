...
template <typename T>
typedef dlib::matrix<T, 0, 1> data_row;
typedef dlib::radial_basis_kernel<data_row> kernel;
class kmeans
{
  public:
    Eigen::Map<Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>> dataPoints;
    int k;
    kmeans() {}
    void set_up_kernel(Eigen::Map<Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>> dataPoints){
